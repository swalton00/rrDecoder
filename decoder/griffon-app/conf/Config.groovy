application {
    ...
    startupGroups = ['decoder', 'prefs', 'dec', 'progress', 'cvs', 'help', 'cvSpecific']
    autoShutdown = true
}
windowManager {
...
mvcGroups {
    ...
    'cvSpecific' {
        model = 'com.spw.rr.CvSpecificModel'
        view  = 'com.spw.rr.CvSpecificView'
        controller = 'com.spw.rr.CvSpecificController'
    }
}