...
CREATE TABLE
    rrdec.decoderType
    (
        id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY CONSTRAINT decoderType_primaryKey PRIMARY 
        KEY,
...
CREATE TABLE
    ...
    (
        ...
        decoderTypeID      INTEGER NOT NULL CONSTRAINT loco_decoder REFERENCES rrdec.decoderType(id) ON 
DELETE 
    RESTRICT,
