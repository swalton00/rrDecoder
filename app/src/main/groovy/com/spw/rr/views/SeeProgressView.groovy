...
class SeeProgressView {
    ...
    void init() {
        SwingUtilities.invokeLater {
            ...
            mainPanel.add(panelTitle, "grow, center, wrap")
            mainPanel.add(model.bar1, "grow, center, wrap")
            mainPanel.add(model.label1, "grow, center, wrap")
            mainPanel.add(model.bar2, "grow, center, wrap")
            mainPanel.add(model.stepLabel, "grow, center, wrap")
            mainPanel.add(model.label2, "grow, center, wrap")
            mainPanel.add(model.bar3, "grow, center, wrap")
            mainPanel.add(model.label3, "grow, center, wrap")
            model.theDialog.getContentPane().add(mainPanel, "grow, center, grow")
